...
namespace LsMsgPack
{
    ...
    public class MpRoot : MsgPackVarLen, IList<MsgPackItem>, IEnumerable<MsgPackItem>, IEnumerable
    {
        ...
        public MpRoot(List<MsgPackItem> packedItems) : base()
        {
            this.packedItems = packedItems;
        }

        public MpRoot(IEnumerable<MsgPackItem> packedItems) : base()
        {
            this.packedItems = new List<MsgPackItem>(packedItems);
        }

        public MpRoot(params MsgPackItem[] packedItems) : base()
        {
            this.packedItems = new List<MsgPackItem>(packedItems);
        }

        public MpRoot(int capacity) : base()
        {
        ...
        {
            MsgPackItem item = UnpackMultiple(data);
            if (item is MpRoot)
        ...
        public override long CalcBytesSize()
        {
            ...
            {
                retVal += packedItems[t].CalcBytesSize();
            }
            return retVal;
        }
